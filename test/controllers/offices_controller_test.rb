...
class OfficesControllerTest < ActionController::TestCase
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post :create, office: { dataRecebimento: @office.dataRecebimento, identificador: @office.identificador, ocorrencia: @office.ocorrencia, siged: @office.siged, sipro: @office.sipro }
    end
  ...
  test "should update office" do
    patch :update, id: @office, office: { dataRecebimento: @office.dataRecebimento, identificador: @office.identificador, ocorrencia: @office.ocorrencia, siged: @office.siged, sipro: @office.sipro }
    assert_redirected_to office_path(assigns(:office))
  end
